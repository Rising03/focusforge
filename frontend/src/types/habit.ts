...
export interface TodayHabitsResponse {
  ...
  habits: {
    ...
    quality_today: 'excellent' | 'good' | 'poor' | null;
...
export interface HabitTrackingState {
  habits: HabitResponse[];
  todayHabits: TodayHabitsResponse | null;
  streaks: HabitStreaksResponse | null;
  consistencyScore: ConsistencyScore | null;
  stackSuggestions: HabitStackSuggestionsResponse | null;
  isLoading: boolean;
  error: string | null;
}
...
export interface HabitCompletionFormData {
  completed: boolean;
  quality: 'excellent' | 'good' | 'poor' | '';
  notes: string;
}
...
// Visualization types
export interface HabitVisualizationData {
  labels: string[];
...
export interface StreakVisualizationData {
  habitName: string;
  streakHistory: {
    date: string;
    streakLength: number;
